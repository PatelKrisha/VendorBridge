...
function getUserFromCookie(): JWTPayload | null {
...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    if (decoded) {
      ...
      setUserName(mockNames[decoded.email] || decoded.email.split('@')[0]);
      
      // Default non-admin users to profile tab
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:border-accent focus:bg-white transition-colors"
                  />
                </div>
                <div>
